...
public class VentasAdapter extends RecyclerView.Adapter<VentasAdapter.ViewHolder> {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public ViewHolder(View v){
            ...
            longitud = (TextView)itemView.findViewById(R.id.textViewLongitudVentas);
            latitud=(TextView)itemView.findViewById(R.id.textViewLatitudVentas);
        }
        ...
        public void bind(final Ventas ventas){
            ...
            longitud.setText(ventas.getLongitud());
            latitud.setText(ventas.getLatitud());
