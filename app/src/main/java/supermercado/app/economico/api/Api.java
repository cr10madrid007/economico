...
public class Api {
    ...
    private static final String URL_BASE = "https://supereconomico.online/movil/";
    private static final String ROOT_URL = URL_BASE + "views/json-movil/Api.php?apicall=";
    private static final String URL_CONTRASENIA = URL_BASE + "views/json-movil/";

    public static final String URL_CREATE_CONTRASENIA = URL_CONTRASENIA + "Contrasenia.php";
    //usuarios
